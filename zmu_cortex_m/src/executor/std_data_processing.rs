...
use super::{conditional_setflags, expand_conditional_carry};
...
pub trait IsaStandardDataProcessing {
    ...
    fn exec_bic_reg(&mut self, params: &Reg3ShiftParams) -> Result<ExecuteResult, Fault>;

    fn exec_adr(&mut self, params: RegImmParams) -> Result<ExecuteResult, Fault>;
    fn exec_mov_reg(&mut self, params: &Reg2Params) -> Result<ExecuteResult, Fault>;
    fn exec_mov_imm(&mut self, params: &RegImmCarryParams) -> Result<ExecuteResult, Fault>;
    fn exec_mvn_reg(&mut self, params: &Reg2ShiftParams) -> Result<ExecuteResult, Fault>;
    fn exec_orn_reg(&mut self, params: &Reg3ShiftParams) -> Result<ExecuteResult, Fault>;
    fn exec_mvn_imm(&mut self, params: &RegImmCarryParams) -> Result<ExecuteResult, Fault>;
    fn exec_orr_reg(&mut self, params: &Reg3ShiftParams) -> Result<ExecuteResult, Fault>;
    fn exec_teq_reg(&mut self, params: &Reg2ShiftNoSetFlagsParams) -> Result<ExecuteResult, Fault>;
    fn exec_teq_imm(
        &mut self,
        params: &RegImmCarryNoSetFlagsParams,
    ) -> Result<ExecuteResult, Fault>;
    fn exec_tst_reg(&mut self, params: &Reg2ShiftNoSetFlagsParams) -> Result<ExecuteResult, Fault>;
    fn exec_tst_imm(
        &mut self,
        params: &RegImmCarryNoSetFlagsParams,
    ) -> Result<ExecuteResult, Fault>;
